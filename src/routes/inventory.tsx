      ...
      <div className="mt-4">
        {loading ? (
          ...
          <EmptyState
            ...
            title="دوچرخه‌ای در انبار نیست"
            description="فقط خریدهای تأییدشده در انبار نمایش داده می‌شوند."
          />
        ) : (
